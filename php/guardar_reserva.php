...
$conn -> query("INSERT INTO tabla_reserva(fecha, hora, estado, id_tutor, id_cumpleanero, id_invitados, id_cafeteria) VALUES ('$fecha', '$hora', 'pendiente', $id_tutor, $id_cumple, $id_invitados, $id_cafeteria)");
